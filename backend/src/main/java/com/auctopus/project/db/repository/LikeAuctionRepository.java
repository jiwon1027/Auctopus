...
//    @Query("SELECT a FROM LikeAuction a WHERE a.auctionSeq= ?1 ")
//    List<LikeAuction> findLikeAuctionListByAuctionSeq(int auctionSeq);

    @Query("SELECT a FROM LikeAuction a WHERE a.userEmail= ?1 AND a.auctionSeq= ?2 ")
