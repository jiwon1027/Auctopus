...
export default function AuctionCreate() {
  ...
  return (
    <Layout>
      <ImageUpload />
      <Content data={data} onChange={(name: string, value: string) => handleChange(name, value)} />
      <Calendar data={data} onChange={(name: string, value: string) => handleChange(name, value)} />
