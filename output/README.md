...
- :tools: fix: 내 코드베이스에서 발생한 버그를 수정했을 때
- :sparkles: feat: 새로운 기능을 추가했을 때
- :exclamation: (ELEMENT)!: API를 바꿨을 때
- :bookmark_tabs: docs: 문서 수정
- :pill: refactor: 코드 리펙토링했을 때
- :tennis: test: 테스트 코드 추가 또는 수정했을 때
- :rainbow: style: 코드 형식 바꿨을 때
- :sparkle: chore: 그 외 기타사항
